...
// --- 纹理相关 ---
 ...
 CONTEXT_API void TexImage1D(GLenum target, GLint level, GLint internalformat,
                       GLsizei width, GLint border, GLenum format, GLenum type,
                       const void *pixels);
 CONTEXT_API void TexImage2D(GLenum target, GLint level, GLint internalformat,
                       GLsizei width, GLsizei height, GLint border,
                       GLenum format, GLenum type, const void *pixels);
 CONTEXT_API void GetTexImage(GLenum target, GLint level, GLenum format, GLenum type,
                        void *pixels);
 ...
 CONTEXT_API void GetTexLevelParameterfv(GLenum target, GLint level, GLenum pname,
                                   GLfloat *params);
 CONTEXT_API void GetTexLevelParameteriv(GLenum target, GLint level, GLenum pname,
                                   GLint *params);

// --- 清屏与缓冲区 ---
 CONTEXT_API void Clear(GLbitfield mask);
 CONTEXT_API void ClearColor(GLfloat red, GLfloat green, GLfloat blue,
                       GLfloat alpha) ;
 ...
 CONTEXT_API void ReadPixels(GLint x, GLint y, GLsizei width, GLsizei height,
...
// --- 状态设置 ---
 ...
 CONTEXT_API void ColorMask(GLboolean red, GLboolean green, GLboolean blue,
                      GLboolean alpha);
...
// --- 顶点、颜色、法线等（Immediate Mode, Legacy）---
 ...
 CONTEXT_API void FramebufferTexture2D(GLenum target, GLenum attachment, GLenum textarget, GLuint texture, GLint level);

 CONTEXT_API void DeleteShader(GLuint shader);
 CONTEXT_API void DeleteProgram(GLuint program);

 CONTEXT_API void ShaderSource(GLuint shader, GLsizei count, const GLchar *const*string, const GLint *length);
 ...
 CONTEXT_API void GetProgramInfoLog(GLuint program, GLsizei bufSize, GLsizei *length, GLchar *infoLog);
 CONTEXT_API void UseProgram(GLuint program);
 CONTEXT_API GLint GetUniformLocation(GLuint program, const GLchar *name);
 CONTEXT_API void UniformMatrix4fv(GLint location, GLsizei count, GLboolean transpose, const GLfloat *value);
 ...
 CONTEXT_API void VertexAttribPointer(GLuint index, GLint size, GLenum type, GLboolean normalized, GLsizei stride, const void *pointer);
